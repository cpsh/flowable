 ...
 */
public class TestTranaction2 {

    public static void main(String[] args) {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("application-context-transaction-2.xml");
        System.out.println(applicationContext.getBean("studentJDBCTemplate"));
        System.out.println(applicationContext.getBean("studentJDBCTemplate") instanceof StudentJDBCTemplate2);
        StudentDao studentJDBCTemplate = (StudentDao) applicationContext.getBean("studentJDBCTemplate");
